...
class Post extends DataClass implements Insertable<Post> {
  ...
  Post copyWith({int? id, String? title}) => Post(
        id: id ?? this.id,
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Post && other.id == this.id && other.title == this.title);
}
...
class PostsCompanion extends UpdateCompanion<Post> {
  ...
  PostsCompanion copyWith({Value<int>? id, Value<String>? title}) {
    return PostsCompanion(
      id: id ?? this.id,
      title: title ?? this.title,
    );
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities => [authors, posts];
}
